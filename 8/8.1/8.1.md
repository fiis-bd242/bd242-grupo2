        ...
        <td>
            <ol>
                <li>
                  ...
                  <li>
                    <strong>Boton Editar: </strong> Cuando el usuario presione el boton editar se ejecutará la siguiente consultas que se mostrarrá en la ventana I06. <br>
                    BLOQUE PRINCIPAL:
                    </br>
...
inner join unidad_medidad um on um.cod_unidad = i.cod_unidad 
inner join almacen a on a.cod_almacen = m.cod_almacen 
inner join tipo_almacen ta on ta.cod_tipo_almacen = a.cod_tipo_almacen 
