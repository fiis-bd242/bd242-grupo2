...
<table border="1" cellpadding="5" cellspacing="0">
    ...
    <tr>
        <td><strong>Imagen Interfaz</strong></td>
        <td>
            <img src="../8.1/Imagenes_modulo4/Asignación_turno.png" alt="Página principal" >
        </td>
    </tr>
    <tr>
        <td><strong>Sentencias SQL</strong></td>
...
Local l ON e.Cod_local = l.Cod_local
WHERE
('' IS NULL OR e.DNI = '6') OR
('' IS NULL OR t.Nombre_turno ILIKE '7') OR
('' IS NULL OR c.Nombre_cargo ILIKE '8') OR
('' IS NULL OR l.Nombre_local ILIKE '9');
</code>
</br>
</li>
