...
<table border="1">
	<tbody>
		...
		<tr>
			<td>2. El usuario coloca el código de orden de compra para verificar la asignación.</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
			<td>3. El sistema muestra "Error: Orden de compra no asignada a usted" en caso de que no haya sido asignada al usuario y muestra la opción de ingresar otro código de orden o volver al móduo.</td>
		</tr>
		<tr>
			<td>-</td>
			<td>4. En caso se le haya asignado la orden de compra el sistema muestra los insumos incluidos en la orden de compra</td>
		</tr>
		<tr>
			<td>5. El supervisor, junto con su equipo, realiza el conteo y va colocando las cantidades que llegaron.</td>
			<td></td>
		</tr>
		<tr>
			<td>6. Una vez revisados todos los insumos, el usuario seleccion la opción "Terminar revisión"</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
			<td>7. EL sistema muestra una pantalla de confirmación con los cantidades ingresadas y con las opciones de "Editar cantidades" o "Confirmar datos"</td>
		</tr>
		<tr>
			<td>8. Si el usuario selecciona "Editar cantidades" puede modificar las cantidades ya ingresadas</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
			<td>9. Si el usuario selecciona "Confirmar datos" el sistema guarda las cantidades y registra la hora de la revisión, además se cambia la etapa en la que se encuentra la orden de compra</td>
		</tr>
		<tr>
			<td>Excepciones</td>
			<td colspan="2"></td>
