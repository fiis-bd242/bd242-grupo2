...
<table border="1">
	<tbody>
		...
		<tr>
			<td>2. El usuario coloca los datos del producto que se agregará al inventario.</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td>-</td>
			<td>2. El sistema muestra los datos de todos los productos .</td>
		</tr>
		<tr>
			<td>3. El usuario coloca el nombre del producto que desea buscar.</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
			<td>4. El sistema filtra y muestra los datos del producto buscado.</td>
		</tr>
		<tr>
			<td>Excepciones</td>
			<td colspan="2"></td>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td>Servicios utilizados</td>
			<td colspan="2">"Buscar" "Balance de producto"</td>
		</tr>
		<tr>
			<td>Requisitos no funcionales</td>
			<td colspan="2">Tiempo de respuesta, usabilidad, manejo de errores</td>
...
# Prototipo
Enlace al prototipo en Figma: [AQUÍ](https://www.figma.com/proto/rm3WcYopPAFZJYwf9MsJ2Q/PROTOTIPO-INVENTARIO?node-id=2-2&node-type=canvas&t=8viUc1JI6sjvU4Uq-1&scaling=contain&content-scaling=fixed&page-id=0%3A1)
