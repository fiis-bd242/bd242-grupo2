...
<table border="1">
	<tbody>
		...
		<tr>
			<td>2. El usuario coloca la categoría, la subcategoría, el nombre, la unidad de medida, las condiciones de conservación y la ubicación del producto que se agregará al inventario.</td>
			<td>-</td>
		</tr>
		<tr>
			<td>-</td>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td>-</td>
			<td>2. El sistema muestra la categoría, subcategoría, código del producto, nombre, unidad de medida, cantidad, fecha de vencimiento, proveedor y lote de todos los productos .</td>
		</tr>
		<tr>
...
![alt text](/CapturasPrototipo/image-4.png)

Pantalla con los datos llenos:

![alt text](/CapturasPrototipo/image-5.png)

Pantalla con los datos por confirmar:

![alt text](/CapturasPrototipo/image-6.png)

Pantalla con los datos confirmados:
![alt text](/CapturasPrototipo/image-7.png)
...
![Nuevo producto vacío](/CapturasPrototipo/image.png)

Pantalla con los datos llenos:

![Nuevo producto lleno](/CapturasPrototipo/image-1.png)

Pantalla con los datos por confirmar:

![alt text](/CapturasPrototipo/image-2.png)

Pantalla con los datos confirmados:

![alt text](/CapturasPrototipo/image-3.png)
