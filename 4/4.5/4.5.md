...
<table border="1">
	<tbody>
		...
		<tr>
			<td>-</td>
			<td>8. El sistema lo lleva a la interfaz inicial y se repite hasta terminar el ingreso de todos los insumos.</td>
		</tr>
		<tr>
			<td>Excepciones</td>
			<td colspan="2"></td>
...
<table border="1">
	<tbody>
		<tr>
			<td>Nombre</td>
			<td colspan="2">Revisar insumo de la hoja de producción</td>
		</tr>
		<tr>
			<td>Tarea realizada por el usuario</td>
