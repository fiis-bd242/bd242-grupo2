...
<head>
    ...
    <title>Detalle del Caso de Uso</title>
    <style>
        table {
            width: 100%;
...
<body>
    ...
    <table>
     ...
     <!CASO DE USO NUMERO 7>
        <h2>
        7. Caso de Uso: Cumplimiento Normativo y Laboral
    </h2>
    <table>
        <tbody>
            <tr>
                <td>Realised Usser task</td>
                <td>  Garantizar que la asignación de turnos cumpla con las normativas laborales.</td>
            </tr>
            <tr>
                <td>Initiating Actors</td>
                <td>Empleado y gerente</td>
            ...
            <tr>
                ...
                <td>
                    <ul>
                       ...
                       <li> Sistema de cumplimiento normativo</li>
                     </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ol>
                        <li>
                       El sistema revisa la programación de turnos y la compara con las normativas laborales establecidas (horas máximas, tiempos de descanso, etc.).</li>
                       <li> El sistema alerta al administrador o gerente si hay incumplimientos de las normativas.</li>
                        <li>El administrador o gerente ajusta la programación de turnos según las recomendaciones del sistema para cumplir con las normativas.</li>
                        <li> El sistema registra y asegura el cumplimiento normativo en la programación de turnos.</li>
                    </ol>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul>
                        <li>Normativas Incumplidas: Si la programación de turnos no cumple con las normativas, el sistema muestra un mensaje de advertencia y sugiere ajustes necesarios.</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul>
                        <li>El sistema debe tener configuradas las normativas laborales relevantes.</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul>
                        <li> La programación de turnos y las horas trabajadas cumplen con las normativas laborales vigentes.</li>
                    </ul>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <ul>
                        <li>Servicio de cumplimiento normativo</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul>
                        <li>Seguridad: La verificación del cumplimiento normativo debe estar protegida y accesible solo para usuarios autorizados.</li>
                        <li>Performance: El sistema debe realizar la verificación de cumplimiento de manera eficiente y precisa.</li>
                    </ul>
                </td>
            </tr>
        </tbody>
      ...
      <!CASO DE USO NUMERO 8>
        <h2>
        8. Caso de Uso: Evaluación del Desempeño
    </h2>
    <table>
        <tbody>
            <tr>
      ...
      <!CASO DE USO NUMERO 9>
        <h2>
        9. Caso de Uso: Integración con Nómina
    </h2>
    <table>
        <tbody>
            <tr>
       ...
       <!CASO DE USO NUMERO 10>
        <h2>
        10. Caso de Uso: Notificación y Comunicación
    </h2>
    <table>
        <tbody>
            <tr>
        ...
        <h2>
        11. Caso de Uso: Reporte y Análisis
    </h2>
    <table>
        <tbody>
            <tr>
        ...
        <h2>
        12. Caso de Uso: Escalabilidad y Adaptibilidad
    </h2>
    <table>
        <tbody>
            <tr>
         ...
         <!CASO DE USO NUMERO 13>
        <h2>
        13. Caso de Uso: Funcionalidades Específicas
    </h2>
    <table>
        <tbody>
            <tr>
