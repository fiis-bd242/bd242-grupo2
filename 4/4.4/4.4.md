...
<body>
    <h2>
    CU001: Caso de uso: Inicio de sesión
    </h2>
    <table>
        <tbody>
            <tr>
    ...
    <h2>
        CU003: Caso de Uso: Gestion de Perfiles de Empleados
    </h2>
    <table>
        <tbody>
            <tr>
    ...
    <h2>
        CU004: Caso de Uso: Asignación y Programación de Turnos
    </h2>
    <table>
        <tbody>
            <tr>
          ...
          <!CASO DE USE NUMERO 4>
    <h2>
        CU005: Caso de Uso: Control de Asistencia
    </h2>
    <table>
        <tbody>
            <tr>
    ...
    <!CASO DE USO NUMERO 6>
        <h2>
        CU006: Caso de Uso: Gestión de Ausencias y Permisos
    </h2>
    <table>
        <tbody>
            <tr>
     ...
     <h2>
        CU007: Caso de Uso: Evaluación del Desempeño
    </h2>
    <table>
        <tbody>
            <tr>
      ...
      <!CASO DE USO NUMERO 8>
        <h2>
        CU008: Caso de Uso: Integración con Nómina
    </h2>
    <table>
        <tbody>
            <tr>
       ...
       <!CASO DE USO NUMERO 9>
        <h2>
        CU009: Caso de Uso: Notificación y Comunicación
    </h2>
    <table>
        <tbody>
            <tr>
    ...
    <table>
        ...
        <h2>
        CU011: Caso de Uso: Escalabilidad y Adaptibilidad
    </h2>
    <table>
        <tbody>
            <tr>
        ...
        <h2>
        CU012: Caso de Uso: Funcionalidades Específicas
    </h2>
    <table>
        <tbody>
            <tr>
...
## IO7: Confirmar eliminación de perfil
## Casos de uso:
...
## I10: Editar turno
## Casos de uso:
![Editar turno](../4.4/Editar_turno.png)

## I11: Eliminar turno asignado
## Casos de uso:
![Eliminar turno asignado](../4.4/Eliminar.png)

## I12: Ausencias y  permisos
## Casos de uso:
![Ausencias y permisos](../4.4/Ausencias_permisos.png)

## I13: Formulario de solicitud
## Casos de uso:
![Formulario de solicitud](../4.4/Formulario_solicitud.png)

## I14: Notificaciones
## Casos de uso:
![Notificaciones](../4.4/Notificaciones.png)

## I15: Redactar Notificaciones
## Casos de uso:
![Redactar notificacion](../4.4/Redactar_Notificaciones.png)

## I16: Desempeño Personal
## Casos de uso:
![Desempeño](../4.4/Desempeño_personal.png)

## I17: Ver notificación
## Casos de uso:
![Ver notificación](../4.4/Ver_Notificaciones.png)
