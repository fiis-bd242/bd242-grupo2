...
CREATE TABLE Contrato (
  ...
  Id_tipo_contrato CHAR (10) NOT NULL,
...
CREATE TABLE Historial_laboral (
  ...
  Duración NUMERIC(10,2) NOT NULL,
  Codigo_empleado CHAR (10) NOT NULL,
...
CREATE TABLE ESTADO_ACTUAL (
  cod_estado_actual CHAR (2) NOT NULL,
  descripcion_estado_actual VARCHAR(20) NOT NULL,
  PRIMARY KEY (cod_estado_actual)
);
...
CREATE TABLE Informe_RC (
  ...
  Fecha_InicioRC INT NOT NULL,
  Fecha_FinRC INT NOT NULL,
  Local_RC INT NOT NULL,
  Codigo_empleado CHAR (10) NOT NULL,
  PRIMARY KEY (Cod_RC)
);
...
CREATE TABLE Solicitud_ReporteCostos (
  ...
  Estado_Solicitud DATE NOT NULL,
  Descripcion_Solicitud DATE NOT NULL,
...
ALTER TABLE Contrato ADD FOREIGN KEY (Id_tipo_contrato) REFERENCES Tipo_Contrato (Cod_tipo_contrato);
...
ALTER TABLE Orden_compra ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Orden_comprainsumo ADD FOREIGN KEY (cod_ordencompra) REFERENCES Orden_compra (cod_ordencompra);

ALTER TABLE Orden_comprainsumo ADD FOREIGN KEY (Cod_Insumo) REFERENCES Insumo (Cod_Insumo);

ALTER TABLE Solicitud_compra ADD FOREIGN KEY (Cod_producto) REFERENCES Insumo (Cod_Insumo);

ALTER TABLE Solicitud_compra ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Cotizacion ADD FOREIGN KEY (cod_solicitudcompra) REFERENCES Solicitud_compra (cod_solicitudcompra);

ALTER TABLE Cotizacion ADD FOREIGN KEY (Cod_Proveedor) REFERENCES Proveedor (Cod_Proveedor);

ALTER TABLE Cotizacion ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Asistencia ADD FOREIGN KEY (Cod_estado) REFERENCES Estado_Asistencia (cod_estado);

ALTER TABLE Horario_libre ADD FOREIGN KEY (Codigo) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Historial_laboral ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Solicitud_o_descargo ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Solicitud_o_descargo ADD FOREIGN KEY (Cod_estado_SD) REFERENCES Estado_SD (Cod_estado_SD);

ALTER TABLE Solicitud_o_descargo ADD FOREIGN KEY (Cod_tipo_sd) REFERENCES Tipo_SD (Cod_tipo_sd);

ALTER TABLE Notificacion ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Notificacion ADD FOREIGN KEY (Cod_tipo_notificacion) REFERENCES Tipo_notificacion (Cod_tipo_notificacion);

ALTER TABLE Notificacion ADD FOREIGN KEY (Cod_tipo_generacion) REFERENCES Tipo_generación (Cod_tipo_generacion);

ALTER TABLE Posee ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Posee ADD FOREIGN KEY (cod_habilidad) REFERENCES Habilidad (Cod_habilidad);

ALTER TABLE Registra ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Registra ADD FOREIGN KEY (Cod_asistencia) REFERENCES Asistencia (Cod_asistencia);

ALTER TABLE Horario_libre_Dias ADD FOREIGN KEY (Cod_horario) REFERENCES Horario_libre (Cod_horario);

ALTER TABLE Usuario ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Usuario ADD FOREIGN KEY (Cod_estado_usuario) REFERENCES Estado_usuario (Cod_estado_usuario);
...
ALTER TABLE EMPLEADO_ITEMDETALLEPEDIDO ADD FOREIGN KEY (cod_estado_actual) REFERENCES ESTADO_ACTUAL (cod_estado_actual);

ALTER TABLE Informe_RC ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Gasto ADD FOREIGN KEY (Codigo_empleado) REFERENCES Empleado (Codigo_empleado);

ALTER TABLE Gasto ADD FOREIGN KEY (Cod_RC) REFERENCES Informe_RC (Cod_RC);
