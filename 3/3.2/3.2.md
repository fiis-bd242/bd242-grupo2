...
Este módulo interactúa con todos los demás módulos, ya que gestiona al personal que realizan las actividades del sistema.
...
- Ingreso de insumos:
  Definición: Permite al jefe de almacén tener un control de los insumos que ingresen para actualizar el inventario cuando los insumos sean aceptados luego de las revisiones.
